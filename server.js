...
// ─── App secret — blocks requests not coming from the iOS app ─────────────────
// Set CRISPER_APP_TOKEN in Railway environment variables.
// The iOS app sends this in the x-app-secret header on every request.
const CRISPER_APP_TOKEN = process.env.CRISPER_APP_TOKEN;
