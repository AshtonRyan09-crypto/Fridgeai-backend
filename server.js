...
// ─── CORS — locked to your app only ──────────────────────────────────────────
// Only your iOS app (via WKWebView using app:// scheme) and localhost for
// testing should be allowed. Reject all other origins.
const ALLOWED_ORIGINS = [
  "app://localhost",      // WKWebView custom scheme
...
app.use(cors({
  origin: (origin, callback) => {
    // Allow requests with no origin (native iOS app doesn't send one)
